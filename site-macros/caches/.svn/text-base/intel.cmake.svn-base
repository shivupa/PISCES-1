...
set( CMAKE_C_COMPILER icc CACHE STRING "C compiler  wrapper" FORCE )
set( CMAKE_CXX_COMPILER icpc CACHE STRING "C++ compiler  wrapper" FORCE )
...
set( CMAKE_CXX_FLAGS_RELEASE "-O3 -DNDEBUG" CACHE STRING ${msg})
set( CMAKE_C_FLAGS_RELEASE "-O3 -DNDEBUG" CACHE STRING ${msg} )
